...
(function($PS) {
  ...
  var genericErrCode = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Screeps.Spawn (line 58, column 1 - line 58, column 52): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var encodeBodyType = function (v) {
      ...
      throw new Error("Failed pattern match at Screeps.Spawn (line 32, column 1 - line 32, column 37): " + [ v.constructor.name ]);
  };
      ...
      return function (bodyTypes) {
          return function (spawnName) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at Screeps.Spawn (line 94, column 23 - line 96, column 109): " + [ v.constructor.name ]);
              };
          };
      };
  };
